...
- [靳灿奇的简历](#靳灿奇的简历)
  ...
  - [工作经历](#工作经历)
    ...
    - [AI 应用研发（2024.10 - 2026.04）](#ai-应用研发202410---202604)
...
在哔哩哔哩上，基于影刀RPA+claude code，根据视频封面识别自己喜欢的视频，然后将其添加到指定的收藏夹

整个流程一共100多步，通过“执行DOS命令”指令调用claude code，通过Try兜底，针对模型输出格式不规范做了重试，针对屏幕缩放导致点击不准做了元素位置偏移矫正，混合使用了js、python代码，抽离了常量，融合了编程思想等。

影刀RPA分享链接：https://api.winrobot360.com/redirect/robot/share?inviteKey=a014ba93da99d610

![影刀流程截图](1778330581396.png)
