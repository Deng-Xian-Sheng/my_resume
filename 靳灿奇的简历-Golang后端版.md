...
- [靳灿奇的简历](#靳灿奇的简历)
  ...
  - [速览本简历](#速览本简历)
  - [工作经历](#工作经历)
    - [长沙谱蓝网络科技有限公司武汉分公司](#长沙谱蓝网络科技有限公司武汉分公司)
    - [武汉花卷科技有限公司](#武汉花卷科技有限公司)
    - [独立开发（2024.10 - 2026.04）](#独立开发202410---202604)
...
<!-- * **基本情况**：今年23岁，我13岁接触互联网，16岁接触编程，2年在校开发经验，2.5年 Golang 商业后端经验，1.5年 AI 独立研发与开源实践，工作地点**全国皆可**（无城市偏好）。 -->

* **基本情况**：今年23岁，我13岁接触互联网，16岁接触编程，2年在校开发经验，2.5年 Golang 商业后端经验，1.5年 AI 独立研发与开源实践，工作地点**武汉**。
...
工资：月薪5.5k(基本工资3300,绩效2200)，试用期5k(基本工资3000,绩效2000)，社保460，公积金100多，实际到手4300左右

日期：2026-06～至今

工作内容：

负责"天工SkyReels"短剧生成模型的数据标注工作。
为了提效，编写了一些工具：
- 基于油猴脚本为label studio添加视频自动播放+视频播放进度条走到最后则回到开始的特性，增加标注流畅性，节省鼠标操作步骤，减轻标注负担
- 基于油猴脚本+文档，为label studio添加了标注标签的帮助卡片，当鼠标悬浮在选项的❓符号上时，显示该选项的判断逻辑，同时支持alt+h快捷键呼出帮助卡片。对理解每个标签的判断逻辑和减少误标有帮助。
- 一些尝试：通过前景背景分离+算法实现自动标注、若干工作中的辅助脚本等。
...
通过vibe coding开发游戏关卡设计工具

内容：

1.修改了codex，添加了一个内置工具使其能够自动设置终端标题，有助于多终端并行开发。
2.独创了基于裸仓库的同仓库多克隆多分支并行vibe coding方法，类似一个虚拟的开发团队，让功能开发和bug修复之间互不干扰，相比单分支方案，提高了开发效率与迭代稳定性。

离职原因：

不太适合这个岗位

### 独立开发（2024.10 - 2026.04） 
...
<!-- 更低 -->
工资可谈，期望，月收入，税前，6k～8k人民币。
<!-- 6-1=5，8-1=7，税后5k～7k -->


## 远程面试

支持远程面试，支持武汉线下面试，随叫随到。
...
- 其他技能
  + 接触过Agent(智能体)、模型训练&微调&部署。
  + 使用过影刀RPA、了解Dify等AI+工作流方面的软件。
